\documentclass[12pt,oneside,letterpaper,chapterprefix=on,listof=nochaptergap]{scrbook}
...
% (c) 2010-2021 Thomas Gredig, Thomas.Gredig@csulb.edu
%
...
\newcommand{\FIGwide}{0.9\textwidth}		% Figure widths (Wide)
\newcommand{\FIGmed}{0.65\textwidth}		% (medium-sized figure)
\newcommand{\FIGnarrow}{0.5\textwidth} 	% (narrow figure)


%%%%%%%%%%%%% Bibliography
\bibliographystyle{apsrev4-2}								% bibliography APS style
...
\DeclareSIUnit\MU{m.u.}									% machine units
\DeclareSIUnit\oersted{Oe}
\DeclareSIUnit\emu{emu}
\DeclareSIUnit\torr{Torr}
\DeclareSIUnit\fu{\textit{f.u.}}								% formula unit



%%%%%%%%%%%%% Commenting / Editing
\usepackage[disable,textsize=tiny]{todonotes}   				% use [disable] to remove all todo notes
...
\addtokomafont{chapterentry}{\mdseries} % make chapter titles not bold
